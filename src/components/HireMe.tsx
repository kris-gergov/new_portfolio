...
const HireMe = () => {
  return (
    <div
      ...
      md:absolute md:right-8 md:left-auto md:top-0 md:bottom-auto"
    >
      <div className="w-48 h-auto flex items-center justify-center relative md:w-24">
        ...
        <Link
          ...
          className="flex items-center justify-center absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 font-semibold
           bg-dark text-light shadow-md border border-solid border-dark dark:border-light w-20 h-20 rounded-full
